    ...
    <section className="flex min-h-screen items-center justify-center px-4 pt-16">
      <div className="mx-auto max-w-4xl text-center">
        ...
        <motion.p
          ...
          className="mb-3 text-2xl font-semibold text-primary sm:text-3xl"
        >
          {t("title")}
        </motion.p>
        ...
        <motion.p
          ...
          className="mb-8 text-lg text-[var(--fg-secondary)]"
        >
          {t("subtitle")}
        </motion.p>
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 rounded-full border border-[var(--card-border)] px-6 py-3 font-medium transition-colors hover:border-primary hover:text-primary"
          >
