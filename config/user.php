...
return [
    'authorized_user' => env('AUTHORIZED_USER_EMAIL', 'johnDoe@gmail.com'),

    'social_media' => [
        'linkedin' => [
            'name' => 'LinkedIn',
            'icon_path' => 'img/social/linkedin.svg#linkedin',
            'profile_url' => env('USER_SOCIAL_LINKEDIN_URL', 'https://linkedin.com'),
        ],

        'github' => [
            'name' => 'GitHub',
            'icon_path' => 'img/social/github.svg#github',
        ...
        'dev' => [
            'name' => 'DEV Community',
            'icon_path' => 'img/social/dev.svg#dev_community',
            'profile_url' => env('USER_SOCIAL_DEV_URL', 'https://dev.to'),
        ],

        'twitter' => [
            'name' => 'Twitter',
            'icon_path' => 'img/social/twitter.svg#twitter',
